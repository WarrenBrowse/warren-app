...
enum HeaderBarStyle: Sendable {
    case transparent, `default`, unsecured, securing, secured
    ...
    fileprivate func backgroundColor() -> UIColor {
        ...
        case .securing:
            return UIColor.HeaderBar.securingBackgroundColor
        case .unsecured:
...
/// Content tone of the header bar: light (white) content over the colored or
/// charcoal bars, dark (black) content over the transparent bar riding the
/// bright scenery sky (desktop main header tone).
enum HeaderBarTone: Sendable {
    case light, dark
}
