...
final class WarrenWalletGenerateViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // No nav-bar title: the hosted view carries its own large title
        // ("Your 12 recovery words") and the localized nav title truncates
        // next to the Cancel button on compact widths.
        title = ""
