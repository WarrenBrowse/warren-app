...
enum VPNSettingsInfoButtonItem: CustomStringConvertible {
    ...
    var description: String {
        ...
        case .allowExternalDns:
            [
                NSLocalizedString(
                    "For advanced users. When enabled, the tunnel stops claiming every DNS query, "
                        + "so apps and resolvers configured outside the tunnel keep working while connected.",
                    comment: ""
                ),
                NSLocalizedString(
