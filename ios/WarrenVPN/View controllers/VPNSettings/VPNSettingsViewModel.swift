...
struct VPNSettingsViewModel: Equatable {
    ...
    private(set) var allowExternalDns: Bool
    ...
    mutating func setAllowExternalDns(_ newValue: Bool) {
        allowExternalDns = newValue
    }
    ...
    init(from tunnelSettings: LatestTunnelSettings = LatestTunnelSettings()) {
        ...
        allowExternalDns = tunnelSettings.allowExternalDns.isEnabled
