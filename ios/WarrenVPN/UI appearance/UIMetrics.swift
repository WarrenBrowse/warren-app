...
extension UIMetrics {
    ...
    /// Height of the one-piece "Warren" wordmark lockup in the header bar
    /// (the W with the ears IS the first letter). Width follows the aspect
    /// ratio of the asset.
    static let headerBarLockupHeight: CGFloat = 34
