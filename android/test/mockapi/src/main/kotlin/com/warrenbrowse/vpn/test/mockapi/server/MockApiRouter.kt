package com.warrenbrowse.vpn.test.mockapi.server
...
import com.warrenbrowse.vpn.test.mockapi.R
import com.warrenbrowse.vpn.test.mockapi.constant.ACCOUNT_URL_PATH
import com.warrenbrowse.vpn.test.mockapi.constant.AUTH_TOKEN_URL_PATH
import com.warrenbrowse.vpn.test.mockapi.constant.CREATE_ACCOUNT_URL_PATH
import com.warrenbrowse.vpn.test.mockapi.constant.DEVICES_ID_URL_PATH
import com.warrenbrowse.vpn.test.mockapi.constant.DEVICES_URL_PATH
import com.warrenbrowse.vpn.test.mockapi.constant.DUMMY_ACCESS_TOKEN
import com.warrenbrowse.vpn.test.mockapi.constant.DUMMY_ID_1
import com.warrenbrowse.vpn.test.mockapi.constant.RELAY_LIST_URL_PATH
import com.warrenbrowse.vpn.test.mockapi.util.accessTokenJsonResponse
import com.warrenbrowse.vpn.test.mockapi.util.accountCreationJson
import com.warrenbrowse.vpn.test.mockapi.util.accountInfoJson
import com.warrenbrowse.vpn.test.mockapi.util.deviceJson
import com.warrenbrowse.vpn.test.mockapi.util.tooManyDevicesJsonResponse
