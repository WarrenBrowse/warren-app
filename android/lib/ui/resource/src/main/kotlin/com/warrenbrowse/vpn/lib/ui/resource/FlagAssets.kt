...
// desktop flag set in desktop/packages/mullvad-vpn/assets/images/flags (circle-flags, MIT). The desktop is the
...
object FlagAssets {
    ...
    fun drawableFor(countryCode: String): Int? =
        when (countryCode.lowercase()) {
            ...
            "cp" -> R.drawable.flag_cp
            "cq" -> R.drawable.flag_cq
            ...
            "xx" -> R.drawable.flag_xx
            "ye" -> R.drawable.flag_ye
            "yt" -> R.drawable.flag_yt
            "yu" -> R.drawable.flag_yu
