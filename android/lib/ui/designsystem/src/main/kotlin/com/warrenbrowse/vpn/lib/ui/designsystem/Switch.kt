...
@Composable
private fun PreviewWarrenSwitch() {
    PreviewColumn() {
        WarrenSwitch(checked = true, onCheckedChange = null)
        WarrenSwitch(checked = false, onCheckedChange = null)
        WarrenSwitch(checked = true, onCheckedChange = null, enabled = false)
        WarrenSwitch(checked = false, onCheckedChange = null, enabled = false)
    }
}
