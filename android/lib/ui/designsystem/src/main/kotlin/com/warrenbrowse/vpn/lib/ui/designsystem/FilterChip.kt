...
@Preview
@Composable
private fun PreviewEnabledWarrenFilterChip() = PreviewColumn {
    WarrenFilterChip(text = "Providers: 10", onRemoveClick = {}, enabled = true)
}

@Preview
@Composable
private fun PreviewDisabledWarrenFilterChip() = PreviewColumn {
    WarrenFilterChip(text = "Providers: 17", onRemoveClick = {}, enabled = false)
}

@Composable
fun WarrenFilterChip(
