...
import com.warrenbrowse.vpn.feature.apiaccess.impl.screen.detail.ApiAccessMethodDetailsSideEffect
...
import com.warrenbrowse.vpn.lib.common.util.delayAtLeast
...
class ApiAccessMethodDetailsViewModelTest {
    ...
    companion object {
        private const val DELAY_UTIL = "com.warrenbrowse.vpn.lib.common.util.DelayKt"
    }
}
