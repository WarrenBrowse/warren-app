...
class SettingsViewModel(
    ...
    val uiState: StateFlow<Lc<Unit, SettingsUiState>> =
        combine(
                ...
                warrenLocalSettings.natPmpEnabled,
                appVersionInfoRepository.versionInfo,
            ) { walletState, daita, multiHop, natPmp, versionInfo ->
                SettingsUiState(
                        ...
                        isMultiHopEnabled = multiHop,
                        isPortForwardingEnabled = natPmp,
                        isPlayBuild = isPlayBuild,
                        availableUpgrade = versionInfo.availableUpgrade,
                    )
