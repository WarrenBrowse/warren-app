...
import com.warrenbrowse.vpn.feature.serveripoverride.api.ResetServerIpOverrideConfirmationNavResult
...
import com.warrenbrowse.vpn.lib.ui.component.listitem.ServerIpOverridesListItem
...
fun ServerIpOverridesScreen(
    ...
    ScaffoldWithSmallTopBar(
        ...
        Column(
            ...
            SnackbarHost(hostState = snackbarHostState) { WarrenSnackbar(snackbarData = it) }
            PrimaryButton(
