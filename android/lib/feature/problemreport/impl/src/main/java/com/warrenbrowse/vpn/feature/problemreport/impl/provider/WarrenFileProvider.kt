package com.warrenbrowse.vpn.feature.problemreport.impl.provider
...
import com.warrenbrowse.vpn.feature.problemreport.impl.R
...
class WarrenFileProvider : FileProvider(R.xml.provider_paths) {
    companion object {
...
fun Context.createShareLogFile(logContent: String): Uri {
    ...
    return WarrenFileProvider.uriForFile(this, cacheFile)
}
