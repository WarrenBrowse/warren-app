...
import com.warrenbrowse.vpn.common.compose.ACCOUNT_NUMBER_CHUNK_SIZE
import com.warrenbrowse.vpn.common.compose.CollectSideEffectWithLifecycle
import com.warrenbrowse.vpn.common.compose.accountNumberKeyboardType
import com.warrenbrowse.vpn.common.compose.accountNumberOutputTransformation
import com.warrenbrowse.vpn.common.compose.accountNumberVisualTransformation
...
import com.warrenbrowse.vpn.lib.ui.tag.LOGIN_BUTTON_TEST_TAG
import com.warrenbrowse.vpn.lib.ui.tag.LOGIN_INPUT_TEST_TAG
import com.warrenbrowse.vpn.lib.ui.tag.LOGIN_REVEAL_INPUT_BUTTON_TEST_TAG
import com.warrenbrowse.vpn.lib.ui.tag.LOGIN_SCREEN_DELETE_ACCOUNT_HISTORY_TEST_TAG
import com.warrenbrowse.vpn.lib.ui.tag.LOGIN_TITLE_TEST_TAG
...
private fun LoginIcon(loginState: LoginState, modifier: Modifier = Modifier) {
    Box(contentAlignment = Alignment.Center, modifier = modifier) {
        when (loginState) {
            ...
            is LoginState.Loading -> WarrenCircularProgressIndicatorLarge()
            LoginState.Success ->
                Image(
