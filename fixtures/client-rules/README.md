...
| `forum_link.json` attach cases | none (no attach builder in the crate yet) | `ForumAttachLinkTest` (`classifyForumAttachLink`, the full class vocabulary) | `forum-login.spec.ts` (`parseForumAttachUrl`) | none |
