...
// Warren fork — Phase H : toggle UI pour `Settings::warren_mode`.
// Réutilise le primitif `Switch` du design system. À placer dans une
// page Settings (e.g. à côté du toggle "Allow LAN") ou dans une page
// dédiée "Warren mode" lorsque l'UX sera maquettée.
