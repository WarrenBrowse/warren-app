  ...
  switch (error) {
    case 'DOWNLOAD_FAILED':
      ...
      return messages.pgettext(
        'app-upgrade-view',
        'Download failed, please check your connection/firewall and try again, or report the problem on our community forum.',
      );
    case 'INSTALLER_FAILED':
      // TRANSLATORS: Label displayed when an error occurred within the installer
      return messages.pgettext(
        'app-upgrade-view',
        'Installer quit unexpectedly, please try again or report the problem on our community forum.',
      );
    case 'START_INSTALLER_FAILED':
      ...
      return messages.pgettext(
        'app-upgrade-view',
        'Could not open installer, please try again or report the problem on our community forum.',
      );
    case 'VERIFICATION_FAILED':
      // TRANSLATORS: Label displayed when an error occurred due to the installer failed verification
      return messages.pgettext(
        'app-upgrade-view',
        'Verification failed, please try again or report the problem on our community forum.',
      );
    default:
      // TRANSLATORS: Label displayed when an unknown error occurred
      return messages.pgettext(
        'app-upgrade-view',
        'Unknown error occurred. Please try again or report the problem on our community forum.',
      );
  }
};
