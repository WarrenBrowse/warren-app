...
WARREN_UPDATE_SIGNING_KEY="$secret" cargo r --bin mullvad-version-metadata --features sign --features client \
    sign --file ./unsigned-response.json > test-version-response.json
