...
impl From<mullvad_types::auth_failed::AuthFailed> for proto::error_state::AuthFailedError {
    fn from(auth_failed: mullvad_types::auth_failed::AuthFailed) -> Self {
        ...
        match auth_failed {
            ...
            AuthFailed::Banned => error_state::AuthFailedError::Banned,
            AuthFailed::BannedPortForwarding => error_state::AuthFailedError::BannedPortForwarding,
...
impl From<proto::error_state::AuthFailedError> for mullvad_types::auth_failed::AuthFailed {
    fn from(auth_failed: proto::error_state::AuthFailedError) -> Self {
        ...
        match auth_failed {
            ...
            error_state::AuthFailedError::Banned => AuthFailed::Banned,
            error_state::AuthFailedError::BannedPortForwarding => AuthFailed::BannedPortForwarding,
