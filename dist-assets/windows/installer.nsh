...
# (Adapted from Mullvad upstream; service identifier `mullvadvpn` is kept until
# Warren-side R2 daemon service rename — the daemon still registers under
# the SERVICE_NAME constant in mullvad-daemon/src/lib.rs.)
