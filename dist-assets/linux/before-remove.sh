...
/opt/Warren\ VPN/resources/mullvad-setup reset-firewall || echo "Failed to reset firewall"
/opt/Warren\ VPN/resources/mullvad-setup remove-device || echo "Failed to remove device from account"
