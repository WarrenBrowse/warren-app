...
/// a distinct service without collision. Per product environment: a
/// beta install keeps its own wallet identity, never prod's.
const SERVICE_NAME: &str = match warren_product_env::CURRENT {
    warren_product_env::ProductEnv::Prod => "net.warrenvpn.daemon",
    warren_product_env::ProductEnv::Staging => "net.warrenvpn.daemon.staging",
    warren_product_env::ProductEnv::Beta => "net.warrenvpn.daemon.beta",
};
